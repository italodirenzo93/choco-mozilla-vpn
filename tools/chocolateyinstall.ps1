...
$url64 = 'https://vpn.mozilla.org/downloads/vpn/windows/v1.1/MozillaVPN.msi' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
...
$packageArgs = @{
  ...
  softwareName   = 'Mozilla VPN' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  ...
  checksum64     = '7ED88D4CCD3058B2ECA1E27B1681121C0D9A78D93B3550D1236F2868024AF22C'
